...
let hrange = ( 0.02f0, 0.06f0, 0.09f0, 0.125f0, 0.26f0, 0.4f0,  0.6f0,  1.6f0,  1.7f0,  2.33f0,  2.4f0,  3.36f0, 3.4f0,  4.8f0 ), # length 14
    ...
    select = (1, 1, 2,13,13,13,13,13,13,13,13,16,16,16, 9,
              ...
              2, 3, 4, 4, 6, 6,18,18,18,18,17,17,17,12,12) # 1-based indices (in 8x15 "matrix")
...
let c2 = (0.99999999999999987510, -0.99999999999988796462, 0.99999999998290743652,
...
let pts = (0.35082039676451715489E-02, 0.31279042338030753740E-01, 0.85266826283219451090E-01,
    ...
    wts = (0.18831438115323502887E-01, 0.18567086243977649478E-01, 0.18042093461223385584E-01,
           ...
           0.81130545742299586629E-02,  0.60419009528470238773E-02, 0.38862217010742057883E-02, 0.16793031084546090448E-02)
    #=
       NOTICE:
...
function owens_t_dispatch(h::Float64, a::Float64, ah::Float64)
    ...
    method == 6 && return owens_t_T6(h, a)
end
